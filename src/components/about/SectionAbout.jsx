...
const SectionAbout = () => {
    const Epoxy = [
        ...
        },
        {
            ...
            explained:
                "Lapangan Olahraga, Parkiran, Lantai Kelas, Laboratorium.",
        },
        {
            id: "6",
        ...
        },
        {
            ...
            name: "PLTU",
            explained:
                "Parkiran, Perpipaan, Cerobong Asap, Lantai Ruang Mesin.",
        },
        {
            id: "10",
            name: "Bandara",
        ...
        },
        {
            ...
            explained:
                "Lantai Produksi, Gudang, Area Service, Lantai Showroom.",
        },
    ];
